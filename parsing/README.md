...
- `parser.py`: pypdfium2 (PDFium, лицензии Apache-2.0 / BSD-3-Clause) читает PDF
  ...
  (без сети): на PDF ВОЗ последовательности слов pypdfium2 и PyMuPDF совпадают на 99,8%,
  pypdf добавляет 8,5% слов с соседней страницы разворота. Поиск эту разницу не различает. python-docx читает абзацы и таблицы DOCX в порядке
